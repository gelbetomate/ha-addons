...
def async_register_websocket_commands(hass: HomeAssistant) -> None:
    ...
    _LOGGER.debug("Registered UluxDisplay WebSocket commands")
...
@websocket_api.websocket_command({vol.Required("type"): "ulux_display/config"})
@callback
def ws_get_config(
    hass: HomeAssistant,
...
@websocket_api.websocket_command({vol.Required("type"): "ulux_display/views/list"})
@callback
def ws_views_list(
    hass: HomeAssistant,
    connection: websocket_api.ActiveConnection,
    ...
    store: UluxDisplayStore = hass.data[DOMAIN]["store"]
    connection.send_result(msg["id"], {"views": store.get_views_list()})


@websocket_api.websocket_command(
    {
        vol.Required("type"): "ulux_display/views/get",
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "ulux_display/views/create",
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "ulux_display/views/update",
        vol.Required("view_id"): str,
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "ulux_display/views/delete",
        vol.Required("view_id"): str,
    }
)
@websocket_api.async_response
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "ulux_display/views/duplicate",
        vol.Required("view_id"): str,
        vol.Optional("name"): str,
    }
)
...
@websocket_api.websocket_command({vol.Required("type"): "ulux_display/devices/list"})
@callback
def ws_devices_list(
    hass: HomeAssistant,
    connection: websocket_api.ActiveConnection,
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "ulux_display/devices/assign_views",
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "ulux_display/devices/settings",
        vol.Required("entry_id"): str,
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "ulux_display/preview/render",
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "ulux_display/entities/list",
...
def _get_coordinator(hass: HomeAssistant, entry_id: str) -> UluxDisplayCoordinator | None:

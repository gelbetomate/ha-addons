...
"""Material Design Icons codepoint mapping."""

# Auto-generated from @mdi/font v7.4.47
# Total icons: 7447
...
MDI_CODEPOINTS: dict[str, str] = {
    ...
    "watermark": "F0612",
    "wave": "F0F2E",
    "wave-arrow-down": "F1CB0",
    "wave-arrow-up": "F1CB1",
    "wave-undercurrent": "F1CC0",
    "waveform": "F147D",
    "waves": "F078D",
    ...
    "weather-hurricane-outline": "F1C78",
    "weather-lightning": "F0593",
    "weather-lightning-rainy": "F067E",
    "weather-moonset": "F1D15",
    "weather-moonset-down": "F1D16",
    "weather-moonset-up": "F1D17",
    "weather-night": "F0594",
    ...
    "wrench": "F05B7",
    "wrench-check": "F1B8F",
    "wrench-check-outline": "F1B90",
    "wrench-clock": "F19A3",
    "wrench-clock-outline": "F1B93",
    "wrench-cog": "F1B91",
    "wrench-cog-outline": "F1B92",
...
# Legacy aliases for backwards compatibility with old geometric icon names
...
def get_mdi_char(icon_name: str) -> str:
    """Get MDI Unicode character for an icon name.

    Supports multiple input formats:
    - Legacy names: "temp" -> thermometer icon
    - HA MDI format: "mdi:thermometer" -> thermometer icon
    - Bare MDI names: "thermometer" -> thermometer icon

    Args:
        icon_name: Icon name in any supported format

    Returns:
        Unicode character for the MDI font
    """
    # Strip "mdi:" prefix if present (HA format)
    icon_name = icon_name.removeprefix("mdi:")

    # Check legacy aliases for backwards compatibility
    if icon_name in LEGACY_ALIASES:
        icon_name = LEGACY_ALIASES[icon_name]

    # Look up codepoint, fall back to help-circle if not found
    codepoint = MDI_CODEPOINTS.get(icon_name)
    if codepoint is None:
        codepoint = MDI_CODEPOINTS.get(FALLBACK_ICON, "F02D7")
...
def is_valid_icon(icon_name: str) -> bool:
    ...
    Returns:
        True if the icon exists in MDI or legacy aliases
    """
    ...
    return icon_name in MDI_CODEPOINTS

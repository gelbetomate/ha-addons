...
| Add-on | Description |
|--------|-------------|
| [u::Lux UMP Bridge](https://github.com/gelbetomate/ha-addons/blob/main/addons/ulux/README.md) | UDP bridge for u::Lux Switch IP devices — decodes UMP key events, auto-initialises switches, and publishes `ulux_event` / `ulux_key` events to Home Assistant and/or MQTT. |
...
|-------------|-------------|
| [u::lux Display](https://github.com/gelbetomate/ha-addons/blob/main/custom_components/ulux_display/README.md) | Rich display engine for u::Lux Switch IP devices with widgets, layouts, themes, and WebSocket-powered management. |

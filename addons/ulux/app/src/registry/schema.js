...
function createDeviceRecord(data) {
  ...
  return {
    ...
    ump_state_flags: data.ump_state_flags ?? null,
    ump_control_flags: data.ump_control_flags ?? null,
    ump_page_count: data.ump_page_count ?? null,
    ump_page_index: data.ump_page_index ?? null,
    ump_last_seen: data.ump_last_seen || null,
